...
export default function HeroSection() {
  return (
    <div
      ...
      style={{
        backgroundImage:
          "linear-gradient(rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)), url('https://images.unsplash.com/photo-1605000797499-95a51c5269ae?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80')",
      }}
    >
      <div className="container mx-auto px-4 text-center md:text-left">
        <div className="bg-opacity-90 inline-block max-w-2xl rounded-lg bg-white p-8 shadow-lg">
          <h1 className="mb-4 text-4xl font-bold text-green-900 md:text-5xl">
            Selamat Datang di Dusun Grenggeng
          </h1>
          <p className="mb-6 text-lg text-gray-700">
            Desa penghasil tahu dan hasil tani berkualitas dengan keindahan
            alam yang mempesona. Kami menjaga tradisi dengan cita rasa yang
            autentik.
          </p>
